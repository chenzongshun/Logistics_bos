...
<textarea name="bug_c" id="bug_c" cols="50" rows="7" style=" border:solid 3px #E2E2E2;line-height:16px; padding:5px;" placeholder="请填写建议，如，我希望能够增自定义bos的主题背景"></textarea>
<br />
...
$('#bug_form').form({  
	...
	onSubmit: function(){  
		if($('#bug_c').val()==""){
			$.messager.alert('Warning',"内容太少了噢！");	
			return false;
		}
	}, 
	success:function(data){  
		$.messager.alert('Bos提示',"感谢您的提出的宝贵建议，我们会改进的哒，爱你么么哒！"); 
		$('#bug_c').val("");
	}  
});   
</script>